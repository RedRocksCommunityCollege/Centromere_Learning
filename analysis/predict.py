...
image_path = ('/Users/cross/Desktop/test1')
...
def predict(loc,x_size,y_size):
    ...
    for image in glob.glob(image_path+'/*.jpg'):
        img = cv2.imread(image) #read in images from glob
        ...
        if preds == 0:
            ...
            cv2.imwrite('/Users/cross/Desktop/images_sharp_not/not_sharp/not_sharp'+str(i)+'.jpg',img1)

        elif preds == 1:
            print('This is sharp')
            cv2.imwrite('/Users/cross/Desktop/images_sharp_not/sharp/sharp'+str(i)+'.jpg',img1)
